...
{
    /// <summary>
    /// based on AdaFruit's library http://github.com/adafruit/ST7735-Library
    /// </summary>
    public class HY18SPI : IDisposable
    {
        ...
        public HY18SPI(Cpu.Pin chipSelect, Cpu.Pin dc, Cpu.Pin reset, SPI.SPI_module spiModule = SPI.SPI_module.SPI1, uint speedKHz = (uint)9500)
        {
